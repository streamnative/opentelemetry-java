...
/**
 * A concurrent pool of objects of type {@code T}.
 *
...
public final class ConcurrentObjectPool<T> {
  private final ConcurrentArrayBasedStack<T> pool;
   ...
   */
  public ConcurrentObjectPool(Supplier<T> objectCreator) {
    this.pool = new ConcurrentArrayBasedStack<>();
